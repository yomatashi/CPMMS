...
"color: rgb(255, 255, 255)")
        ...
        sizePolicy1.setHeightForWidth(self.btn_addMember.sizePolicy().hasHeightForWidth())
        self.btn_addMember.setSizePolicy(sizePolicy1)
...
"color: rgb(255, 255, 255)")
        ...
        sizePolicy1.setHeightForWidth(self.btn_listMember.sizePolicy().hasHeightForWidth())
        self.btn_listMember.setSizePolicy(sizePolicy1)
...
"color: rgb(255, 255, 255)")
        ...
        self.input_fileName.setMinimumSize(QSize(232, 0))
        self.input_fileName.setMaximumSize(QSize(328, 30))
...
"color: rgb(255, 255, 255)")
        ...
        icon2 = QIcon()
        icon2.addFile(u":/icons/rotate-cw.svg", QSize(), QIcon.Normal, QIcon.Off)
        self.btn_refreshMem.setIcon(icon2)
        ...
        self.btn_deleteMemEdit.setFont(font)
...
"color: rgb(255, 255, 255);")
        ...
        self.btn_updateMemEdit.setFont(font)
...
"color: rgb(255, 255, 255);")
        ...
        sizePolicy5.setHeightForWidth(self.input_fullName_admin.sizePolicy().hasHeightForWidth())
        self.input_fullName_admin.setSizePolicy(sizePolicy5)
        ...
        sizePolicy4.setHeightForWidth(self.lbl_admin_email.sizePolicy().hasHeightForWidth())
        self.lbl_admin_email.setSizePolicy(sizePolicy4)
        ...
        sizePolicy4.setHeightForWidth(self.lbl_adminID.sizePolicy().hasHeightForWidth())
        self.lbl_adminID.setSizePolicy(sizePolicy4)
        ...
        sizePolicy5.setHeightForWidth(self.input_jobPosition.sizePolicy().hasHeightForWidth())
        self.input_jobPosition.setSizePolicy(sizePolicy5)
        ...
        self.btn_updateAdmin.setFont(font)
...
"color: rgb(255, 255, 255);")
        ...
        sizePolicy7.setHeightForWidth(self.frame_43.sizePolicy().hasHeightForWidth())
        self.frame_43.setSizePolicy(sizePolicy7)
        ...
        sizePolicy7.setHeightForWidth(self.frame_41.sizePolicy().hasHeightForWidth())
        self.frame_41.setSizePolicy(sizePolicy7)
        ...
        sizePolicy2.setHeightForWidth(self.frame_46.sizePolicy().hasHeightForWidth())
        self.frame_46.setSizePolicy(sizePolicy2)
        ...
        sizePolicy1.setHeightForWidth(self.lbl_member_status.sizePolicy().hasHeightForWidth())
        self.lbl_member_status.setSizePolicy(sizePolicy1)
        ...
        sizePolicy8.setHeightForWidth(self.btn_pay.sizePolicy().hasHeightForWidth())
        self.btn_pay.setSizePolicy(sizePolicy8)
...
"color: rgb(255, 255, 255);")
        ...
        sizePolicy1.setHeightForWidth(self.lbl_total.sizePolicy().hasHeightForWidth())
        self.lbl_total.setSizePolicy(sizePolicy1)
        ...
        sizePolicy9.setHeightForWidth(self.tbl_checkout.sizePolicy().hasHeightForWidth())
        self.tbl_checkout.setSizePolicy(sizePolicy9)
        ...
        sizePolicy1.setHeightForWidth(self.lbl_total_pts.sizePolicy().hasHeightForWidth())
        self.lbl_total_pts.setSizePolicy(sizePolicy1)
        ...
        sizePolicy.setHeightForWidth(self.btn_usepts.sizePolicy().hasHeightForWidth())
        self.btn_usepts.setSizePolicy(sizePolicy)
        self.btn_usepts.setMinimumSize(QSize(140, 40))
        self.btn_usepts.setMaximumSize(QSize(140, 40))
        self.btn_usepts.setFont(font)
...
"color: rgb(255, 255, 255);")
        ...
        self.btn_remove_member.setFont(font)
...
"background-color: rgb(255, 255, 255);")
        ...
        sizePolicy6.setHeightForWidth(self.frame_50.sizePolicy().hasHeightForWidth())
        self.frame_50.setSizePolicy(sizePolicy6)
        ...
        sizePolicy4.setHeightForWidth(self.frame_54.sizePolicy().hasHeightForWidth())
        self.frame_54.setSizePolicy(sizePolicy4)
        ...
        self.btn_cancel_pymnt.setFont(font)
...
"color: rgb(255, 255, 255);")
        ...
        self.btn_cancel_pymnt.setIcon(icon3)
        ...
        self.btn_ok_pymnt.setFont(font)
...
"color: rgb(255, 255, 255);")
        icon4 = QIcon()
        icon4.addFile(u":/icons/check.svg", QSize(), QIcon.Normal, QIcon.Off)
        self.btn_ok_pymnt.setIcon(icon4)
        ...
        sizePolicy1.setHeightForWidth(self.btn_add_item.sizePolicy().hasHeightForWidth())
        self.btn_add_item.setSizePolicy(sizePolicy1)
...
"color: rgb(255, 255, 255)")
        ...
        sizePolicy1.setHeightForWidth(self.btn_list_item.sizePolicy().hasHeightForWidth())
        self.btn_list_item.setSizePolicy(sizePolicy1)
        self.btn_list_item.setMinimumSize(QSize(300, 0))
        self.btn_list_item.setMaximumSize(QSize(16777215, 50))
        self.btn_list_item.setFont(font)
...
"color: rgb(255, 255, 255)")
        ...
        sizePolicy6.setHeightForWidth(self.frame_61.sizePolicy().hasHeightForWidth())
        self.frame_61.setSizePolicy(sizePolicy6)
        ...
        sizePolicy6.setHeightForWidth(self.frame_58.sizePolicy().hasHeightForWidth())
        self.frame_58.setSizePolicy(sizePolicy6)
        ...
        self.gridLayout_15.addWidget(self.input_item_name, 4, 2, 1, 1)
        ...
        self.gridLayout_15.addWidget(self.label_28, 3, 2, 1, 1)
        ...
        self.gridLayout_15.addWidget(self.input_barcode, 2, 2, 1, 2)
        ...
        self.gridLayout_15.addWidget(self.frame_63, 1, 0, 14, 2)
        ...
        self.gridLayout_15.addWidget(self.label_32, 0, 2, 1, 1, Qt.AlignHCenter)

        self.label_36 = QLabel(self.frame_62)
        self.label_36.setObjectName(u"label_36")
        self.label_36.setMaximumSize(QSize(16777215, 30))

        self.gridLayout_15.addWidget(self.label_36, 5, 2, 1, 1)

        self.input_item_category = QLineEdit(self.frame_62)
        self.input_item_category.setObjectName(u"input_item_category")
        self.input_item_category.setMinimumSize(QSize(0, 0))
        self.input_item_category.setMaximumSize(QSize(330, 30))
        self.input_item_category.setStyleSheet(u"background-color: rgb(255, 255, 255)")

        self.gridLayout_15.addWidget(self.input_item_category, 6, 2, 1, 1)

        self.label_30 = QLabel(self.frame_62)
        self.label_30.setObjectName(u"label_30")
        self.label_30.setMaximumSize(QSize(16777215, 30))

        self.gridLayout_15.addWidget(self.label_30, 7, 2, 1, 1)
        ...
        self.gridLayout_15.addWidget(self.input_price, 8, 2, 1, 1)

        self.label_33 = QLabel(self.frame_62)
        self.label_33.setObjectName(u"label_33")
        self.label_33.setMaximumSize(QSize(16777215, 30))

        self.gridLayout_15.addWidget(self.label_33, 9, 2, 1, 1)
        ...
        self.gridLayout_15.addWidget(self.input_stock, 10, 2, 1, 1)
        ...
        self.gridLayout_15.addWidget(self.frame_64, 1, 3, 14, 2)
...
"color: rgb(255, 255, 255)")
        ...
        self.gridLayout_15.addWidget(self.btn_addItem, 12, 2, 1, 1)
        ...
        self.btn_import_excel_option.setFont(font)
...
"color: rgb(255, 255, 255)")
        ...
        self.gridLayout_15.addWidget(self.btn_import_excel_option, 13, 2, 1, 1)
        ...
        self.btn_upload_excel.setFont(font)
...
"color: rgb(255, 255, 255)")
        ...
        self.btn_refreshItem.setIcon(icon2)
        ...
        if (self.tbl_itemList.columnCount() < 5):
            self.tbl_itemList.setColumnCount(5)
        ...
        self.tbl_itemList.setHorizontalHeaderItem(4, __qtablewidgetitem13)
        ...
        sizePolicy6.setHeightForWidth(self.frame_81.sizePolicy().hasHeightForWidth())
        self.frame_81.setSizePolicy(sizePolicy6)
        ...
        self.gridLayout_19.addWidget(self.label_39, 2, 1, 1, 1)
        ...
        self.gridLayout_19.addWidget(self.input_stock_edit, 6, 3, 1, 1)
        ...
        self.gridLayout_19.addWidget(self.label_38, 1, 0, 1, 5, Qt.AlignHCenter)
        ...
        self.gridLayout_19.addWidget(self.input_barcodeID_edit, 2, 3, 1, 1)

        self.label_42 = QLabel(self.frame_75)
        self.label_42.setObjectName(u"label_42")
        self.label_42.setMaximumSize(QSize(16777215, 30))

        self.gridLayout_19.addWidget(self.label_42, 4, 1, 1, 2)

        self.label_40 = QLabel(self.frame_75)
        self.label_40.setObjectName(u"label_40")
        self.label_40.setMaximumSize(QSize(16777215, 30))

        self.gridLayout_19.addWidget(self.label_40, 3, 1, 1, 1)

        self.input_itemCategory_edit = QLineEdit(self.frame_75)
        self.input_itemCategory_edit.setObjectName(u"input_itemCategory_edit")
        self.input_itemCategory_edit.setMinimumSize(QSize(0, 0))
        self.input_itemCategory_edit.setMaximumSize(QSize(16777215, 30))
        self.input_itemCategory_edit.setFont(font5)
        self.input_itemCategory_edit.setStyleSheet(u"background-color: rgb(255, 255, 255)")

        self.gridLayout_19.addWidget(self.input_itemCategory_edit, 4, 3, 1, 1)
        ...
        self.gridLayout_19.addWidget(self.input_price_edit, 5, 3, 1, 1)

        self.label_37 = QLabel(self.frame_75)
        self.label_37.setObjectName(u"label_37")
        self.label_37.setMaximumSize(QSize(16777215, 30))

        self.gridLayout_19.addWidget(self.label_37, 6, 1, 1, 2)
        ...
        self.gridLayout_19.addWidget(self.input_itemName_edit, 3, 3, 1, 1)

        self.frame_77 = QFrame(self.frame_75)
        self.frame_77.setObjectName(u"frame_77")
        self.frame_77.setMinimumSize(QSize(150, 0))
        self.frame_77.setFrameShape(QFrame.StyledPanel)
        self.frame_77.setFrameShadow(QFrame.Raised)

        self.gridLayout_19.addWidget(self.frame_77, 2, 0, 5, 1)

        self.frame_76 = QFrame(self.frame_75)
        self.frame_76.setObjectName(u"frame_76")
        self.frame_76.setMinimumSize(QSize(150, 0))
        self.frame_76.setFrameShape(QFrame.StyledPanel)
        self.frame_76.setFrameShadow(QFrame.Raised)

        self.gridLayout_19.addWidget(self.frame_76, 2, 4, 5, 1)

        self.btn_back_item = QPushButton(self.frame_75)
        self.btn_back_item.setObjectName(u"btn_back_item")
        self.btn_back_item.setMaximumSize(QSize(75, 23))
        self.btn_back_item.setStyleSheet(u"background-color: rgba(217,217,217,255)")

        self.gridLayout_19.addWidget(self.btn_back_item, 0, 0, 1, 1)
...
"color: rgb(255, 255, 255);")
        ...
        self.btn_updateItem.setFont(font)
...
"color: rgb(255, 255, 255);")
        ...
        sizePolicy11.setHeightForWidth(self.btn_member_manager.sizePolicy().hasHeightForWidth())
        self.btn_member_manager.setSizePolicy(sizePolicy11)
        ...
        sizePolicy11.setHeightForWidth(self.btn_item_manager.sizePolicy().hasHeightForWidth())
        self.btn_item_manager.setSizePolicy(sizePolicy11)
        ...
        sizePolicy11.setHeightForWidth(self.btn_checkout.sizePolicy().hasHeightForWidth())
        ...
        sizePolicy11.setHeightForWidth(self.btn_member_verification.sizePolicy().hasHeightForWidth())
    ...
    def retranslateUi(self, Form):
        ...
        self.label_36.setText(QCoreApplication.translate("Form", u"<html><head/><body><p><span style=\" font-size:12pt;\">Item category</span></p></body></html>", None))
        self.input_item_category.setText("")
        ...
        ___qtablewidgetitem11.setText(QCoreApplication.translate("Form", u"Category", None));
        ...
        self.label_42.setText(QCoreApplication.translate("Form", u"<html><head/><body><p><span style=\" font-size:12pt;\">Item Category:</span></p></body></html>", None))
        ...
        self.input_itemCategory_edit.setText("")
